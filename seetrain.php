                ...
                $result1 = mysqli_query($conn,$sql);
                    ...
                    echo "<table>
                            ...
                            <tr>
                                ...
                                <td>" . $row["date"]. "</td>
                                <td>" . $row["deleted"]. "</td>
                                <td> <a href='edit_train.php?id=$id'  id='edit'>Edit</a></td>
                                <td> <a href='delete_train.php?id=$id' class='delete'> Delete </a></td>
