    ...
    <main>
        ...
        <section id="home" class="hero">
            ...
            <div class="container01">
                ...
                <a href="planbook.php"><button onclick="window.location.href='planbook.php'">Book Now</button></a>
            </div>
        ...
        <section class="featured-events">
            <div class="event-card" class="items">
                ...
                <a href="metrobook.php"><button>Book Now</button></a>
            </div>
            ...
            <div class="event-card">
                ...
                <a href="trainbook.php"><button>Book Now</button></a>
            </div>
            ...
            <div class="event-card">
                ...
                <h2>Air Plan</h2>
                <p>Cheer for your favorite team in the grand arena.</p>
                <a href="planbook.php"><button>Book Now</button></a>
            </div>
        </section>
        ...
        <section class="featured-events">
            <div class="event-card">
                ...
                <h2> GSRTC Bus</h2>
                <p>Get ready for an unforgettable musical experience.</p>
                <a href="gsrtcbook.php"><button>Book Now</button></a>
            </div>
            ...
            <div class="event-card">
                ...
                <h2>BRTS Bus</h2>
                <p>Get ready for an unforgettable musical experience.</p>
                <a href="brtsbook.php"><button>Book Now</button></a>
            </div>
