...
.hero {
    background: url('images/brts.jpg') no-repeat center center/cover;
    color: #fff;
    text-align: center;
    padding: 10rem 0;
    position: relative;
    ...
    <main>
        ...
        <section id="home" class="hero">
         ...
         <br><br>
                ...
                <img src="images/brts.jpg" alt="Image 1" class="cardimg">
                <h2>BRTS Bus</h2>
            ...
            <?php
                ...
                $sql = "SELECT * FROM brts WHERE deleted !=1";
                ...
                $result1 = mysqli_query($conn,$sql);
                    ...
                    echo "<table>
                            ...
                            <tr>
                                ...
                                <td>" . $row["1to"]. "</td>
                                <td>30Rs</td>
                                <td> <a href='brts_reservations.php?id=$id'  id='pay' class='button1'>Book</a></td>
