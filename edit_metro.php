...
$sql1 = "SELECT * FROM gsrtc WHERE id='$id'";
...
<body>
   <div class="container">
       ...
       <main class="main-content">
           ...
           <header>
               <h1>Update Metro Train Details , Admin</h1>
           </header>

         
           <form action="update_metro_form.php"method="post">
               ...
               <input type="text" id="from" name="from" value="<?php echo $fetch["1from"]; ?>" required>

               <label for="to">To:</label>
               <input type="text" id="to" name="to" value="<?php echo $fetch["1to"]; ?>"required>
