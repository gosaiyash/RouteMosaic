...
.hero {
    background: url('images/amts102.jpg') no-repeat center center/cover;
    color: #fff;
    text-align: center;
    padding: 10rem 0;
    position: relative;
    ...
    <main>
        ...
        <section id="home" class="hero">
         ...
         <br><br>
                ...
                <img src="images/amts101.jpg" alt="Image 1" class="cardimg">
                <h2>AMTS Bus</h2>
            ...
            <?php
                ...
                $sql = "SELECT * FROM amts WHERE deleted !=1";
                ...
                $result1 = mysqli_query($conn,$sql);
                    ...
                    echo "<table>
                            ...
                            <tr>
                                ...
                                <td>" . $row["to0"]. "</td>
                                <td>35Rs</td>
                                 <td> <a href='amts_reservations.php?id=$id'  id='pay' class='button1'>Book</a></td>
